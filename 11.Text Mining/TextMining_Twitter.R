...
teste <- searchTwitter('sachin_rt', n = 1000, since = '2020-01-01', retryOnRateLimit = 1e3)
...
# twitter extraction 
tweets_ext <-userTimeline("sachin_rt",n=1000)
tweets_df <- twListToDF(tweets_ext)
write.csv(tweets_df,"sachin_rt.csv")
getwd()
